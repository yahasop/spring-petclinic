...
There is no `Dockerfile` in this project. (There is now. Change2) You can build a container image (if you have a docker daemon) using the Spring Boot build plugin:
